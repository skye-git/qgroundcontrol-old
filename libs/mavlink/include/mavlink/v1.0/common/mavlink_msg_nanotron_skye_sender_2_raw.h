// MESSAGE NANOTRON_SKYE_SENDER_2_RAW PACKING

#define MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_2_RAW 139

typedef struct __mavlink_nanotron_skye_sender_2_raw_t
{
...
} mavlink_nanotron_skye_sender_2_raw_t;
...
#define MAVLINK_MESSAGE_INFO_NANOTRON_SKYE_SENDER_2_RAW { \
	"NANOTRON_SKYE_SENDER_2_RAW", \
	6, \
	{  { "distance_1", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_1) }, \
         { "distance_2", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_2) }, \
         { "distance_3", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_3) }, \
         { "distance_4", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_4) }, \
         { "distance_5", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_5) }, \
         { "distance_6", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_nanotron_skye_sender_2_raw_t, distance_6) }, \
         } \
}


/**
 * @brief Pack a nanotron_skye_sender_2_raw message
 ...
 */
static inline uint16_t mavlink_msg_nanotron_skye_sender_2_raw_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_nanotron_skye_sender_2_raw_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
...
/**
 * @brief Send a nanotron_skye_sender_2_raw message
...
#if MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_2_RAW_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_nanotron_skye_sender_2_raw_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float distance_1, float distance_2, float distance_3, float distance_4, float distance_5, float distance_6)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_nanotron_skye_sender_2_raw_t *packet = (mavlink_nanotron_skye_sender_2_raw_t *)msgbuf;
	packet->distance_1 = distance_1;
	packet->distance_2 = distance_2;
	packet->distance_3 = distance_3;
	packet->distance_4 = distance_4;
...
// MESSAGE NANOTRON_SKYE_SENDER_2_RAW UNPACKING


/**
 * @brief Get field distance_1 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 1
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_1(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field distance_2 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 2
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_2(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  4);
}

/**
 * @brief Get field distance_3 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 3
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_3(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field distance_4 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 4
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_4(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  12);
}

/**
 * @brief Get field distance_5 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 5
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_5(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  16);
}

/**
 * @brief Get field distance_6 from nanotron_skye_sender_2_raw message
 *
 * @return Distance to Receiver module 6
 */
static inline float mavlink_msg_nanotron_skye_sender_2_raw_get_distance_6(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  20);
}

/**
 * @brief Decode a nanotron_skye_sender_2_raw message into a struct
 *
 * @param msg The message to decode
 * @param nanotron_skye_sender_2_raw C-struct to decode the message contents into
 */
static inline void mavlink_msg_nanotron_skye_sender_2_raw_decode(const mavlink_message_t* msg, mavlink_nanotron_skye_sender_2_raw_t* nanotron_skye_sender_2_raw)
{
#if MAVLINK_NEED_BYTE_SWAP
	nanotron_skye_sender_2_raw->distance_1 = mavlink_msg_nanotron_skye_sender_2_raw_get_distance_1(msg);
	nanotron_skye_sender_2_raw->distance_2 = mavlink_msg_nanotron_skye_sender_2_raw_get_distance_2(msg);
	nanotron_skye_sender_2_raw->distance_3 = mavlink_msg_nanotron_skye_sender_2_raw_get_distance_3(msg);
	nanotron_skye_sender_2_raw->distance_4 = mavlink_msg_nanotron_skye_sender_2_raw_get_distance_4(msg);
