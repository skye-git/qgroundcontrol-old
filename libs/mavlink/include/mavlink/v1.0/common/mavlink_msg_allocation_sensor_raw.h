...
#define MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_CRC 212
#define MAVLINK_MSG_ID_137_CRC 212
						       ...
						       int32_t pos_1, int32_t pos_2, int32_t pos_3, int32_t pos_4)
{
	...
	char buf[MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN];
	_mav_put_int32_t(buf, 0, pos_1);
	_mav_put_int32_t(buf, 4, pos_2);
	_mav_put_int32_t(buf, 8, pos_3);
	_mav_put_int32_t(buf, 12, pos_4);

        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#else
	...
	packet.pos_4 = pos_4;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif
}
						           ...
						           int32_t pos_1,int32_t pos_2,int32_t pos_3,int32_t pos_4)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif
}

/**
 * @brief Encode a allocation_sensor_raw struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a allocation_sensor_raw struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param allocation_sensor_raw C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_allocation_sensor_raw_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_allocation_sensor_raw_t* allocation_sensor_raw)
{
	return mavlink_msg_allocation_sensor_raw_pack_chan(system_id, component_id, chan, msg, allocation_sensor_raw->pos_1, allocation_sensor_raw->pos_2, allocation_sensor_raw->pos_3, allocation_sensor_raw->pos_4);
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW, buf, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW, buf, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif
#else
	mavlink_allocation_sensor_raw_t packet;
	packet.pos_1 = pos_1;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW, (const char *)&packet, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW, (const char *)&packet, MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif
#endif
}
...
#else
	memcpy(allocation_sensor_raw, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ALLOCATION_SENSOR_RAW_LEN);
#endif
}
