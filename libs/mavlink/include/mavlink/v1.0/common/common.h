...
enum MAV_CMD
{
	...
	MAV_CMD_RESET_SKYE_AU=247, /* Request the reset of an actuation unit. |index of the actuation unit (0-3)| 0: do nothing, 1: reset| Empty| Empty| Empty| Empty| Empty|  */
...
enum MAV_ACTUATION_UNIT_STATUS
{
...
#include "./mavlink_msg_position_controller_raw.h"
#include "./mavlink_msg_attitude_controller_raw.h"
#include "./mavlink_msg_allocation_controller_raw.h"
#include "./mavlink_msg_allocation_sensor_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_1_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_2_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_3_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_4_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_5_raw.h"
#include "./mavlink_msg_nanotron_skye_sender_6_raw.h"
#include "./mavlink_msg_led_control.h"
#include "./mavlink_msg_actuation_status.h"
#include "./mavlink_msg_battery_status.h"
#include "./mavlink_msg_battery_cells_status.h"
