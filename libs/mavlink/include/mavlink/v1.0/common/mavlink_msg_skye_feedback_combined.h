...
#define MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED_LEN 108
#define MAVLINK_MSG_ID_131_LEN 108

#define MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED_CRC 65
#define MAVLINK_MSG_ID_131_CRC 65
...
#define MAVLINK_MESSAGE_INFO_SKYE_FEEDBACK_COMBINED { \
	...
	{  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_skye_feedback_combined_t, timestamp) }, \
         ...
         { "omega_ekf", NULL, MAVLINK_TYPE_FLOAT, 3, 32, offsetof(mavlink_skye_feedback_combined_t, omega_ekf) }, \
         { "quat_ekf", NULL, MAVLINK_TYPE_FLOAT, 4, 44, offsetof(mavlink_skye_feedback_combined_t, quat_ekf) }, \
         { "thrust", NULL, MAVLINK_TYPE_FLOAT, 6, 60, offsetof(mavlink_skye_feedback_combined_t, thrust) }, \
         { "angle", NULL, MAVLINK_TYPE_FLOAT, 6, 84, offsetof(mavlink_skye_feedback_combined_t, angle) }, \
         } \
}
...
static inline uint16_t mavlink_msg_skye_feedback_combined_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t timestamp, const float *omega_raw, const float *accel_raw, const float *omega_ekf, const float *quat_ekf, const float *thrust, const float *angle)
{
	...
	_mav_put_float_array(buf, 32, omega_ekf, 3);
	_mav_put_float_array(buf, 44, quat_ekf, 4);
	_mav_put_float_array(buf, 60, thrust, 6);
	_mav_put_float_array(buf, 84, angle, 6);
...
{
	return mavlink_msg_skye_feedback_combined_pack(system_id, component_id, msg, skye_feedback_combined->timestamp, skye_feedback_combined->omega_raw, skye_feedback_combined->accel_raw, skye_feedback_combined->omega_ekf, skye_feedback_combined->quat_ekf, skye_feedback_combined->thrust, skye_feedback_combined->angle);
}
...
{
	return mavlink_msg_skye_feedback_combined_pack_chan(system_id, component_id, chan, msg, skye_feedback_combined->timestamp, skye_feedback_combined->omega_raw, skye_feedback_combined->accel_raw, skye_feedback_combined->omega_ekf, skye_feedback_combined->quat_ekf, skye_feedback_combined->thrust, skye_feedback_combined->angle);
}
...
static inline void mavlink_msg_skye_feedback_combined_send(mavlink_channel_t chan, uint64_t timestamp, const float *omega_raw, const float *accel_raw, const float *omega_ekf, const float *quat_ekf, const float *thrust, const float *angle)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED_LEN];
	_mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline void mavlink_msg_skye_feedback_combined_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, const float *omega_raw, const float *accel_raw, const float *omega_ekf, const float *quat_ekf, const float *thrust, const float *angle)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
	return _MAV_RETURN_float_array(msg, omega_ekf, 3,  32);
}
...
{
	return _MAV_RETURN_float_array(msg, quat_ekf, 4,  44);
}
...
{
	return _MAV_RETURN_float_array(msg, thrust, 6,  60);
}
...
{
	return _MAV_RETURN_float_array(msg, angle, 6,  84);
}
