...
#define MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_CRC 165
#define MAVLINK_MSG_ID_143_CRC 165
						       ...
						       float distance_1, float distance_2, float distance_3, float distance_4, float distance_5, float distance_6)
{
	...
	char buf[MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN];
	...
	_mav_put_float(buf, 20, distance_6);
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#else
	...
	packet.distance_6 = distance_6;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif
}
						           ...
						           float distance_1,float distance_2,float distance_3,float distance_4,float distance_5,float distance_6)
{
	...
	msg->msgid = MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif
}

/**
 * @brief Encode a nanotron_skye_sender_6_raw struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a nanotron_skye_sender_6_raw struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param nanotron_skye_sender_6_raw C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_nanotron_skye_sender_6_raw_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_nanotron_skye_sender_6_raw_t* nanotron_skye_sender_6_raw)
{
	return mavlink_msg_nanotron_skye_sender_6_raw_pack_chan(system_id, component_id, chan, msg, nanotron_skye_sender_6_raw->distance_1, nanotron_skye_sender_6_raw->distance_2, nanotron_skye_sender_6_raw->distance_3, nanotron_skye_sender_6_raw->distance_4, nanotron_skye_sender_6_raw->distance_5, nanotron_skye_sender_6_raw->distance_6);
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW, buf, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW, buf, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif
#else
	mavlink_nanotron_skye_sender_6_raw_t packet;
	packet.distance_1 = distance_1;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW, (const char *)&packet, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW, (const char *)&packet, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif
#endif
}

#if MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_nanotron_skye_sender_6_raw_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float distance_1, float distance_2, float distance_3, float distance_4, float distance_5, float distance_6)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_nanotron_skye_sender_6_raw_t *packet = (mavlink_nanotron_skye_sender_6_raw_t *)msgbuf;
	packet->distance_1 = distance_1;
	packet->distance_2 = distance_2;
	packet->distance_3 = distance_3;
	packet->distance_4 = distance_4;
...
#else
	memcpy(nanotron_skye_sender_6_raw, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_6_RAW_LEN);
#endif
}
