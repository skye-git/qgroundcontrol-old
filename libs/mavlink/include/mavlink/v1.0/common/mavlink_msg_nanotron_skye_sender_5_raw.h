						       ...
						       float distance_1, float distance_2, float distance_3, float distance_4, float distance_5, float distance_6)
{
	...
	return mavlink_finalize_message(msg, system_id, component_id, 24, 58);
}
						           ...
						           float distance_1,float distance_2,float distance_3,float distance_4,float distance_5,float distance_6)
{
	...
	msg->msgid = MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_5_RAW;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 24, 58);
}

/**
 * @brief Encode a nanotron_skye_sender_5_raw struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
static inline void mavlink_msg_nanotron_skye_sender_5_raw_send(mavlink_channel_t chan, float distance_1, float distance_2, float distance_3, float distance_4, float distance_5, float distance_6)
{
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_5_RAW, buf, 24, 58);
#else
	mavlink_nanotron_skye_sender_5_raw_t packet;
	packet.distance_1 = distance_1;
	packet.distance_2 = distance_2;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NANOTRON_SKYE_SENDER_5_RAW, (const char *)&packet, 24, 58);
#endif
}
...
#else
	memcpy(nanotron_skye_sender_5_raw, _MAV_PAYLOAD(msg), 24);
#endif
}
