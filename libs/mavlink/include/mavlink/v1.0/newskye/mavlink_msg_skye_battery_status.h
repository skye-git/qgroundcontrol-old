...
#define MAVLINK_MSG_ID_SKYE_BATTERY_STATUS 151
...
typedef struct __mavlink_skye_battery_status_t
{
 ...
 uint8_t accu_id; ///< Accupack ID recording to enumerator MAV_SKYE_BATTERY_PACK_ID
...
#define MAVLINK_MSG_ID_SKYE_BATTERY_STATUS_LEN 12
...
#define MAVLINK_MESSAGE_INFO_SKYE_BATTERY_STATUS { \
	...
	{  { "voltage_cell_1", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_skye_battery_status_t, voltage_cell_1) }, \
         ...
         { "accu_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_skye_battery_status_t, accu_id) }, \
         { "battery_remaining", NULL, MAVLINK_TYPE_INT8_T, 0, 11, offsetof(mavlink_skye_battery_status_t, battery_remaining) }, \
         } \
}
 ...
 *
 * @param accu_id Accupack ID recording to enumerator MAV_SKYE_BATTERY_PACK_ID
...
static inline uint16_t mavlink_msg_skye_battery_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t accu_id, uint16_t voltage_cell_1, uint16_t voltage_cell_2, uint16_t voltage_cell_3, uint16_t voltage_cell_4, int16_t current_battery, int8_t battery_remaining)
{
	...
	_mav_put_int8_t(buf, 11, battery_remaining);
	...
	return mavlink_finalize_message(msg, system_id, component_id, 12, 77);
}
						           ...
						           uint8_t accu_id,uint16_t voltage_cell_1,uint16_t voltage_cell_2,uint16_t voltage_cell_3,uint16_t voltage_cell_4,int16_t current_battery,int8_t battery_remaining)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SKYE_BATTERY_STATUS;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 12, 77);
}
...
{
	return mavlink_msg_skye_battery_status_pack(system_id, component_id, msg, skye_battery_status->accu_id, skye_battery_status->voltage_cell_1, skye_battery_status->voltage_cell_2, skye_battery_status->voltage_cell_3, skye_battery_status->voltage_cell_4, skye_battery_status->current_battery, skye_battery_status->battery_remaining);
}
...
static inline void mavlink_msg_skye_battery_status_send(mavlink_channel_t chan, uint8_t accu_id, uint16_t voltage_cell_1, uint16_t voltage_cell_2, uint16_t voltage_cell_3, uint16_t voltage_cell_4, int16_t current_battery, int8_t battery_remaining)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_uint16_t(buf, 0, voltage_cell_1);
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SKYE_BATTERY_STATUS, buf, 12, 77);
#else
	mavlink_skye_battery_status_t packet;
	packet.voltage_cell_1 = voltage_cell_1;
	packet.voltage_cell_2 = voltage_cell_2;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SKYE_BATTERY_STATUS, (const char *)&packet, 12, 77);
#endif
}
 ...
 *
 * @return Accupack ID recording to enumerator MAV_SKYE_BATTERY_PACK_ID
 */
...
#else
	memcpy(skye_battery_status, _MAV_PAYLOAD(msg), 12);
#endif
}
