...
typedef struct __mavlink_skye_motor_meassured_position_t
{
 ...
 uint16_t pos1_raw; ///< Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 uint16_t pos2_raw; ///< Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 uint16_t pos3_raw; ///< Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 uint16_t pos4_raw; ///< Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
...
#define MAVLINK_MESSAGE_INFO_SKYE_MOTOR_MEASSURED_POSITION { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_skye_motor_meassured_position_t, time_usec) }, \
         { "pos1_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_skye_motor_meassured_position_t, pos1_raw) }, \
         { "pos2_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 6, offsetof(mavlink_skye_motor_meassured_position_t, pos2_raw) }, \
         { "pos3_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 8, offsetof(mavlink_skye_motor_meassured_position_t, pos3_raw) }, \
         { "pos4_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 10, offsetof(mavlink_skye_motor_meassured_position_t, pos4_raw) }, \
         } \
}
 ...
 * @param pos1_raw Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 * @param pos2_raw Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 * @param pos3_raw Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 * @param pos4_raw Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
...
static inline uint16_t mavlink_msg_skye_motor_meassured_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_usec, uint16_t pos1_raw, uint16_t pos2_raw, uint16_t pos3_raw, uint16_t pos4_raw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_uint32_t(buf, 0, time_usec);
	_mav_put_uint16_t(buf, 4, pos1_raw);
	_mav_put_uint16_t(buf, 6, pos2_raw);
	_mav_put_uint16_t(buf, 8, pos3_raw);
	_mav_put_uint16_t(buf, 10, pos4_raw);
	...
	return mavlink_finalize_message(msg, system_id, component_id, 12, 241);
}
						           ...
						           uint32_t time_usec,uint16_t pos1_raw,uint16_t pos2_raw,uint16_t pos3_raw,uint16_t pos4_raw)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SKYE_MOTOR_MEASSURED_POSITION;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 12, 241);
}
...
static inline void mavlink_msg_skye_motor_meassured_position_send(mavlink_channel_t chan, uint32_t time_usec, uint16_t pos1_raw, uint16_t pos2_raw, uint16_t pos3_raw, uint16_t pos4_raw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_uint32_t(buf, 0, time_usec);
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SKYE_MOTOR_MEASSURED_POSITION, buf, 12, 241);
#else
	mavlink_skye_motor_meassured_position_t packet;
	packet.time_usec = time_usec;
	packet.pos1_raw = pos1_raw;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SKYE_MOTOR_MEASSURED_POSITION, (const char *)&packet, 12, 241);
#endif
}
 ...
 */
static inline uint16_t mavlink_msg_skye_motor_meassured_position_get_pos1_raw(const mavlink_message_t* msg)
{
 ...
 * @return Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 */
static inline uint16_t mavlink_msg_skye_motor_meassured_position_get_pos2_raw(const mavlink_message_t* msg)
{
 ...
 * @return Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 */
static inline uint16_t mavlink_msg_skye_motor_meassured_position_get_pos3_raw(const mavlink_message_t* msg)
{
 ...
 * @return Meassureed orientation motor 1 (Homing position: 0, 360deg: 36000)
 */
static inline uint16_t mavlink_msg_skye_motor_meassured_position_get_pos4_raw(const mavlink_message_t* msg)
{
