#ifndef BLUEFOXRECONFIGURE_H
#define BLUEFOXRECONFIGURE_H

//#include "skye.h"

#include <QObject>

class BluefoxReconfigure : public QObject
{
    Q_OBJECT
...
public:
    explicit BluefoxReconfigure(QObject *parent = 0);
