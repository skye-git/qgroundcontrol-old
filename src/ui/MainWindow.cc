...
void MainWindow::init()
{
    ...
    connect(mouse, SIGNAL(resetInputMode(SkyeMAV::QGC_INPUT_MODE)), skyeControl, SLOT(updateInput(SkyeMAV::QGC_INPUT_MODE)));
...
//        pilotView->setCentralWidget(new QGCMapTool(this));
    ...
    qDebug() << "create skye control widget";
    // Begin Code Skye
//    createDockWidget(pilotView,new PrimaryFlightDisplay(320,240,this),tr("Primary Flight Display"),"PRIMARY_FLIGHT_DISPLAY_DOCKWIDGET",VIEW_FLIGHT,Qt::LeftDockWidgetArea,QSize(this->width()/1.8,0));
    ...
    createDockWidget(pilotView,skyeControl,tr("Skye Control"),"UAS_SKYE_CONTROL_DOCKWIDGET",VIEW_FLIGHT,Qt::LeftDockWidgetArea, QSize(this->width()/3.2,0));
