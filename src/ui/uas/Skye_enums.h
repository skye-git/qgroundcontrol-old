...
#define BATTERY_STATUS_BIT_ATTACHED     0x01
#define BATTERY_STATUS_BIT_UNDERVOLTAGE 0x02
#define BATTERY_STATUS_BIT_DISABLED     0x04
#define BATTERY_STATUS_BIT_CHARGING     0x08
#define BATTERY_STATUS_BIT_BALANCING    0x10
#define BATTERY_STATUS_BIT_FULL         0x20
#define BATTERY_STATUS_BIT_ERROR        0x80
